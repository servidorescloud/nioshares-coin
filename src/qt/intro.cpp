...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Nioshares Core"),
     ...
     * override -datadir in the nioshares.conf file in the default data directory
     * (to be consistent with niosharesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
