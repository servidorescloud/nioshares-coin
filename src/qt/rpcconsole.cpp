                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNIOPathCustom = GetArg("-zniobackuppath", "");
    ...
    if(!strzNIOPathCustom.empty()) {
        ui->wallet_customzniobackuppath->setText(QString::fromStdString(strzNIOPathCustom));
        ui->wallet_customzniobackuppath_label->setVisible(true);
        ui->wallet_customzniobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNIOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Nioshares RPC console.") + "<br>" +
