...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NIO);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNiosharesAmount"))
        SoftSetArg("-anonymizeniosharesamount", settings.value("nAnonymizeNiosharesAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nioshares.cpp during shotdown to also remove the window positions
