...
/** Utility functions used by the Nioshares Qt UI.
 */
namespace GUIUtil
{
...
// Render Nioshares addresses in monospace font
...
// Parse "nioshares:" URI into recipient object, return true on successful parsing
