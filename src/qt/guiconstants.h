...
/* Nioshares GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nioshares"
#define QAPP_ORG_DOMAIN "nioshares.org"
#define QAPP_APP_NAME_DEFAULT "Nioshares-Qt"
#define QAPP_APP_NAME_TESTNET "Nioshares-Qt-testnet"
