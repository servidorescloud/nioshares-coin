...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nioshares Core nioshares-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nioshares-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nioshares transaction") + "\n" +
                               "  nioshares-tx [options] -create [commands]   " + _("Create hex-encoded nioshares transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nioshares transaction
