...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Nioshares server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Nioshares server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nioshares features */
        {"nioshares", "listmasternodes", &listmasternodes, true, true, false},
        {"nioshares", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nioshares", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nioshares", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nioshares", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nioshares", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nioshares", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nioshares", "masternodedebug", &masternodedebug, true, true, false},
        {"nioshares", "startmasternode", &startmasternode, true, true, false},
        {"nioshares", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nioshares", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nioshares", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nioshares", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nioshares", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nioshares", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nioshares", "preparebudget", &preparebudget, true, true, false},
        {"nioshares", "submitbudget", &submitbudget, true, true, false},
        {"nioshares", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nioshares", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nioshares", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nioshares", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nioshares", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nioshares", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nioshares", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nioshares", "checkbudgets", &checkbudgets, true, true, false},
        {"nioshares", "mnsync", &mnsync, true, true, false},
        {"nioshares", "spork", &spork, true, true, false},
        {"nioshares", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getznioseed", &getznioseed, false, false, true},
        {"zerocoin", "setznioseed", &setznioseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznio", &searchdznio, false, false, true},
        {"zerocoin", "dzniostate", &dzniostate, false, false, true},
...
{
    return "> nioshares-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21037/\n";
}
