...
#ifndef Nioshares_ZNIOWALLET_H
#define Nioshares_ZNIOWALLET_H
...
public:
    CzNIOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNIO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNIO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
