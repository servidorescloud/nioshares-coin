...
#ifndef Nioshares_ZNIOTRACKER_H
#define Nioshares_ZNIOTRACKER_H
...
public:
    CzNIOTracker(std::string strWalletFile);
    ~CzNIOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNIOWallet* zNIOWallet = NULL);
