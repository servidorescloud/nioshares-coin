Contributing to Nioshares Core
============================

The Nioshares Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nioshares-project/nioshares/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Nioshares Core project, and is not to be
confused with overall Nioshares Network Protocol consensus changes.

Whether a pull request is merged into Nioshares Core rests with the project merge
...
Patches that change Nioshares consensus rules are considerably more involved than
...
Where a patchset proposes to change the Nioshares consensus, it must have been
...
The project leader is the release manager for each Nioshares Core release.
