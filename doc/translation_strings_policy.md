...
This document provides guidelines for internationalization of the Nioshares Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Nioshares network</numerusform>
            <numerusform>%n active connections to Nioshares network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nioshares_en.ts` remains unchanged.
