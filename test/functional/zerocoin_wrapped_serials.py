...
from fake_stake.base_test import Nioshares_FakeStakeTest

class zNIOwrappedSerialsTest(Nioshares_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNIOs..." % DENOM_TO_USE)
