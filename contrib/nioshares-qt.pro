...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nioshares-cli.cpp \
           src/nioshares-tx.cpp \
           src/nioshares.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/nioshares.qrc src/qt/nioshares_locale.qrc

TRANSLATIONS += src/qt/locale/nioshares_bg.ts \
                src/qt/locale/nioshares_de.ts \
                src/qt/locale/nioshares_en.ts \
                src/qt/locale/nioshares_es.ts \
                src/qt/locale/nioshares_fi.ts \
                src/qt/locale/nioshares_fr.ts \
                src/qt/locale/nioshares_it.ts \
                src/qt/locale/nioshares_ja.ts \
                src/qt/locale/nioshares_pl.ts \
                src/qt/locale/nioshares_pt.ts \
                src/qt/locale/nioshares_ru.ts \
                src/qt/locale/nioshares_sk.ts \
                src/qt/locale/nioshares_sv.ts \
                src/qt/locale/nioshares_vi.ts \
                src/qt/locale/nioshares_zh_CN.ts \
                src/qt/locale/nioshares_zh_TW.ts
